                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-items-center table-flush">
                                    ...
                                    @if (session('cart'))
                                        ...
                                        @foreach (session('cart') as $id => $details)
                                            ...
                                            <tr>
                                                ...
                                                <td data-th="Price">
                                                    @if ($details['disc'] > 0)
                                                    <small><s>Rp. {{ number_format($details['harga']) }}</s> -{{ $details['disc']*100 }}% </small>
                                ...
                                <tfoot>
                                    @if (session('cart'))
                                        <tr>
                                            <td class="d-flex justify-content-start"><a href="{{ url('/') }}"
                                            ...
                                            <td class="d-flex justify-content-end"><a href="{{ route('checkOut') }}"
                                                    class="btn btn-warning">Continue to Checkout <i
